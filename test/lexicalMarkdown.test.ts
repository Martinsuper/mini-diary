...
const transformers = [BOLD_STAR, BOLD_UNDERSCORE, ITALIC_STAR, ITALIC_UNDERSCORE, ORDERED_LIST, UNORDERED_LIST];

function roundTrip(markdown: string): string {
	const editor = createEditor({ namespace: "test", nodes: [ListNode, ListItemNode], onError: error => { throw error; } });
	editor.update((): void => {
